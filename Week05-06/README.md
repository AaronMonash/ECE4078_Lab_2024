...
[NOTE] Please check the aspect ratio of your training images collected by your robot shown in [image properties](lab_output/pred_0.png) and update the [image_width](TargetPoseEst.py#L54) if needed.
...
[NOTE] This example detector was trained using a total of 1000 images (around 100 manually annotated), with 4 photos taken by the robot on each of the three types of targets from different viewing angles and the rest of the image generated by randomising the background. The fruits and vegetables used in the class may be different from this example
